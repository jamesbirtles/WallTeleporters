...
public class GuiWallTeleporter extends GuiFunContainer {
  ...
  protected void drawGuiContainerForegroundLayer(int mx, int my) {
    fontRendererObj.drawString(teleporter.getInventoryName(), 28, 68, 0x373737);
    ...
    if (teleporter.getWTNetwork().hasDestination()) {
      ...
      int locationYOffset = 10;
      fontRendererObj.drawString(worldName, 88 - fontRendererObj.getStringWidth(worldName) / 2, locationYOffset, 0x404040);
      fontRendererObj.drawString(coords, 88 - fontRendererObj.getStringWidth(coords) / 2, locationYOffset + 12, 0x404040);
      fontRendererObj.drawString(yaw, 88 - fontRendererObj.getStringWidth(yaw) / 2, locationYOffset + 24, 0x404040);
    }
    ...
    if (GameSettings.isKeyDown(Minecraft.getMinecraft().gameSettings.keyBindSneak)) {
      fontRendererObj.drawString(StatCollector.translateToLocal("wallteleporters.gui.sneakHelp"), 28, 78, 0x6a6a6a);
    } else {
      fontRendererObj.drawString(StatCollector.translateToLocal("wallteleporters.gui.sneakForHelp"), 28, 78, 0x6a6a6a);
    }
  }
